   ...
   <!DOCTYPE html>
    ...
    <body>
            <div class="registration_form">
                    <div class="Header">
                        <img src="../Images/default.png" width="200px" height="200px" alt="Be-farm logo" style="border-radius:50%;">
                        ...
                        <div class="form_reg">                 
                            <div class="reg_form">
                                <form method="post" action="../Includes/signup.inc.php">
                                    ...
                                    <label for="consty">Constituency:</label><br>
                                    <input type="text" id="consty" name="consty" required><br>
